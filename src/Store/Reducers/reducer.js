...
export var donorReducer = (state = INITIAL_STATE, action) => {
    console.log("action in donor reducer", action)
    switch (action.type) {

        case Constants.REGISTER_DONOR:
            return Object.assign({}, state)

        case Constants.REGISTER_DONOR_SUCCESS:
            return Object.assign({}, state, { user: action.RegisterDonorData })

        case Constants.REGISTER_DONOR_FAILED:
            return Object.assign({}, state, { hasError: true, errorMessage: action.error })

        case Constants.VIEW_DONOR:
            return Object.assign({}, state)

        case Constants.VIEW_DONOR_SUCCESS:
            return Object.assign({}, state, { donor: action.donorsList })

        case Constants.VIEW_DONOR_FAILED:
            return Object.assign({}, state, { hasError: true, errorMessage: action.error })
